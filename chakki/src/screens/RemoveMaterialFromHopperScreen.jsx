  ...
  return (
    <>
      ...
      <AppDialog
        ...
        icon="help-circle"
        title="Help"
        message="Material is blocking the hopper. Clear it out completely, then tap CONTINUE to proceed."
        confirmLabel="Got it"
...
/* -------------------------------------------------------------------------- */
/*  HopperHero — warning-toned status visualization (attention pulse)          */
/* -------------------------------------------------------------------------- */
const HERO = 260;
    ...
    <Screen background={colors.background}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.message}>
          Clear the material from the hopper immediately, then continue.
        </Text>

        <WarningPill label="Clear the hopper" />
      </View>

      <BottomActionBar>
        <PrimaryButton title="CONTINUE" icon="check" onPress={handleContinue} />
      </BottomActionBar>
    </Screen>
  );
};
