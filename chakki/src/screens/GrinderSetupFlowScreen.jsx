  ...
  return (
    <>
      ...
      <AppDialog
        ...
        icon="help-circle"
        title="Help"
        message="This short setup walks you through connecting and configuring your grinder. Tap NEXT to begin."
        confirmLabel="Got it"
...
/* -------------------------------------------------------------------------- */
/*  SetupHero — layered visualization, matching CleaningHero's composition    */
/* -------------------------------------------------------------------------- */
const HERO = 260;
  ...
  return (
    <View style={styles.hero}>
      ...
      <View style={styles.disc}>
        <StatusIcon icon="settings" variant="info" size={64} />
      </View>
    </View>
  );
};
...
const GrinderSetupFlowScreen = ({ navigation }) => {
  ...
  return (
    <Screen background={colors.background}>
      ...
      {/* Hero composition: step -> visual -> eyebrow -> title -> description */}
      <View style={styles.content}>
        <StepIndicator total={3} current={0} style={{ marginBottom: spacing.huge }} />

        <SetupHero />

        <Eyebrow style={{ marginTop: spacing.xxxl }}>Get started</Eyebrow>
        <Text style={styles.title}>Grinder setup</Text>
        <Text style={styles.message}>
          Let's configure your grinder. This only takes a moment.
        </Text>
      </View>
