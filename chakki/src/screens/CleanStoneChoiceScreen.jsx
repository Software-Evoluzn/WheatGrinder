  ...
  return (
    <>
      ...
      <AppDialog
        ...
        icon="help-circle"
        title="Help"
        message="Cleaning the stone is recommended whenever you change the grain, to prevent flavor carryover."
        confirmLabel="Got it"
...
/* -------------------------------------------------------------------------- */
/*  StoneHero — layered visualization, matching CleaningHero's composition    */
/* -------------------------------------------------------------------------- */
const HERO = 260;
  ...
  return (
    <View style={styles.hero}>
      ...
      <View style={styles.disc}>
        <StatusIcon icon="disc" variant="info" size={64} />
      </View>
    </View>
  );
};
...
const CleanStoneChoiceScreen = ({ navigation }) => {
  ...
  return (
    <Screen background={colors.background}>
      ...
      {/* Hero composition: visual -> title -> description */}
      <View style={styles.content}>
        <StoneHero />

        <Text style={styles.title}>Do you want to clean the stone?</Text>
        <FootNote style={styles.footnote}>Recommended when the grain is changed</FootNote>
      </View>

      <BottomActionBar>
        <PrimaryButton title="YES" icon="check" onPress={handleYes} />
        <SecondaryButton title="NO" onPress={handleNo} style={{ marginTop: spacing.md }} />
      </BottomActionBar>
    </Screen>
  );
};
